...
public static class Strings
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["IdleBody"] = "Open Relay on your phone, tap Start Sharing, then scan the code it shows.",
    ...
    private static readonly Dictionary<string, string> Fa = new()
    {
        ...
        ["IdleBody"] = "رله را روی گوشی باز کنید، «شروع اشتراک‌گذاری» را بزنید، سپس کدی را که نشان می‌دهد اسکن کنید.",
