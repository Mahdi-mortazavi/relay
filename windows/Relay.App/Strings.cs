...
public static class Strings
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["ErrPhoneRepliesBlocked"] = "The phone says its replies aren't leaving it, so connecting would time out. This is almost always a VPN on the phone swallowing them. On the phone, open the VPN app and exclude Relay in its per-app or split-tunnel list — that is the fix that works. If the VPN has no such list, turn off \"Block connections without VPN\" in Settings → Network → VPN → the gear beside its name. Either way the VPN keeps running and Relay shares it. Then click the phone again.",
    ...
    private static readonly Dictionary<string, string> Fa = new()
    {
        ...
        ["ErrPhoneRepliesBlocked"] = "گوشی می‌گوید پاسخ‌هایش از آن بیرون نمی‌رود، پس اتصال به تایم‌اوت می‌خورد. تقریباً همیشه وی‌پی‌ان روی گوشی آن‌ها را می‌بلعد. روی گوشی، برنامهٔ وی‌پی‌ان را باز کنید و رله را در فهرست هر-برنامه یا split-tunnel آن مستثنا کنید — این همان چیزی است که جواب می‌دهد. اگر وی‌پی‌ان چنین فهرستی ندارد، «Block connections without VPN» را در تنظیمات ← شبکه ← VPN ← چرخ‌دنده کنار نامش خاموش کنید. در هر دو حالت وی‌پی‌ان روشن می‌ماند و رله همان را به اشتراک می‌گذارد. بعد دوباره روی گوشی کلیک کنید.",
