...
public static class Strings
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["CodePairingWaiting"] = "Waiting for approval on your phone…",
        ["ErrPairingDenied"] = "Pairing was declined on the phone. Tap Allow on the phone's prompt to connect.",
        ["ErrPairingVersion"] = "The phone runs an incompatible version of Relay. Please update Relay on both devices.",
        ["ErrTitlePairing"] = "Pairing request",
    };
    ...
    private static readonly Dictionary<string, string> Fa = new()
    {
        ...
        ["BusyDetail"] = "بررسی شبکه و اعمال تنظیمات",
        ...
        ["ErrFullModeNeedsQr"] = "آن گوشی در حالت کامل اشتراک می‌گذارد؛ این حالت فقط با اسکن کد QR یا تایید کد جفت می‌شود.",
        ...
        ["ErrProxyApply"] = "ویندوز تغییر را نپذیرفت. برنامه‌های دیگر VPN/پراکسی را ببندید و دوباره تلاش کنید.",
        ["ErrRollback"] = "رله نتوانست تنظیمات را کاملاً بازگرداند. برای تلاش دوباره، دوباره «قطع اتصال» را بزنید.",
        ["ErrTitleElevation"] = "حالت کامل به اجازه نیاز دارد",
        ["ErrTitleTunnel"] = "تونل بالا نیامد",
        ["ErrWgElevationDeclined"] = "حالت کامل باید یک آداپتور شبکه بسازد و ویندوز این کار را فقط با اجازهٔ شما انجام می‌دهد. در پنجرهٔ ویندوز «بله» را بزنید.",
        ["ErrWgStartFailed"] = "رله نتوانست تونل را بالا بیاورد. اگر VPN دیگری روشن است ببندید و دوباره تلاش کنید.",
        ["ErrWgNoHandshake"] = "تونل بالا آمد ولی گوشی پاسخی نداد. کد QR گوشی با هر بار شروع دوبارهٔ اشتراک عوض می‌شود؛ همان کدی را که الان روی گوشی است استفاده کنید.",
        ...
        ["CodePairingWaiting"] = "در انتظار تأیید روی گوشی شما…",
        ["ErrPairingDenied"] = "درخواست اتصال روی گوشی تایید نشد. روی اعلان گوشی دکمه Allow را بزنید.",
        ["ErrPairingVersion"] = "نسخه رله روی گوشی با این نسخه سازگار نیست. لطفاً رله را روی هر دو دستگاه به‌روزرسانی کنید.",
        ["ErrTitlePairing"] = "درخواست جفت‌سازی",
    };
}
