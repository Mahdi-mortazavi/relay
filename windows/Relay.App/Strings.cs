...
public static class Strings
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["ErrPhoneRepliesBlocked"] = "The phone says its replies aren't leaving it, so connecting would time out. This is almost always a VPN on the phone. On the phone: Settings → Network → VPN → the gear beside the VPN app's name, and turn off \"Block connections without VPN\". The VPN itself keeps running — Relay shares it. Then click the phone again.",
    ...
    private static readonly Dictionary<string, string> Fa = new()
    {
        ...
        ["ErrPhoneRepliesBlocked"] = "گوشی می‌گوید پاسخ‌هایش از آن بیرون نمی‌رود، پس اتصال به تایم‌اوت می‌خورد. تقریباً همیشه به‌خاطر وی‌پی‌ان روی گوشی است. روی گوشی: تنظیمات ← شبکه ← VPN ← چرخ‌دنده کنار نام برنامهٔ وی‌پی‌ان، و «Block connections without VPN» را خاموش کنید. خودِ وی‌پی‌ان روشن می‌ماند — رله همان را به اشتراک می‌گذارد. بعد دوباره روی گوشی کلیک کنید.",
