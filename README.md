...
<sub>The loop above is silent — <b>press play for the whole sixty seconds, with sound.</b> The interface in it is drawn rather than screen-recorded; the walkthrough below is the unedited real thing. The file is in the repo as <a href="docs/assets/relay-film.mp4"><code>docs/assets/relay-film.mp4</code></a>.</sub>
